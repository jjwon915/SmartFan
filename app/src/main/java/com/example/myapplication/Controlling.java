...
public class Controlling extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDevice = b.getParcelable(AddFragment.DEVICE_EXTRA);
        mDeviceUUID = UUID.fromString(b.getString(AddFragment.DEVICE_UUID));
        mMaxChars = b.getInt(AddFragment.BUFFER_SIZE);
